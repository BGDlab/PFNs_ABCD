...
# observed weight map
weights_act_A = np.load("Haufe_PRS_040724/Weight_Haufe_040724/PRS_1_A_weight_haufetrans_all.npy") 
weights_act_B = np.load("Haufe_PRS_040724/Weight_Haufe_040724/PRS_1_B_weight_haufetrans_all.npy") 
...
np.savetxt("weight_maps_HaufeAAB/sig_testing/PRS_1_vertex_SOW_python.csv", weights_act_sum, delimiter=",", header="SOW", comments="")
...
for dir_letter in string.ascii_uppercase[:10]:  # 'A' through 'J'
    ...
    for i in range(0, 100):
        fn_A = f"PRS_1_A_Weight_haufetrans_all_{i}.npy"
        fp_A = os.path.join(dir_path, fn_A)
        fn_B = f"PRS_1_B_Weight_haufetrans_all_{i}.npy"
...
np.savetxt("weight_maps_HaufeAAB/sig_testing/PRS_1_TFCE_act.csv", tfce_act, delimiter=",", header="tfce_score", comments="")
...
np.savetxt("weight_maps_HaufeAAB/sig_testing/PRS_1_TFCE_p_vals.csv", p_fwe, delimiter=",", header="p_fwe", comments="")
